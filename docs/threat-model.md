...
| **O11** | Breached-password check (HIBP k-anonymity range query) at signup + password reset (ASVS 2.1.7). | Low | Jai Akash | 2026-07-09 | ✅ Resolved 2026-07-12 (`auth/breached-password.ts`, fail-open, `HIBP_CHECK` env, unit+integration tested) |
