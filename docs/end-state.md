...
Wave 4 (live broker integration) is **not** part of v1.2 done — it lands at the v1.3 / v2.0 boundary depending on whether broker work happens before or after the cloud rebuild in §18.
