    ...
    <div className="max-w-md space-y-8">
      ...
      <section className="space-y-2">
        ...
        <p className="text-caption text-text-muted">
          Open the folder where your database and exports are stored. You can point your sync tool
          (Dropbox, iCloud, etc.) to this folder for automatic backup.
        </p>
      ...
      <section className="space-y-2">
        ...
        <p className="text-caption text-text-muted">
          Export all data as a timestamped JSON file saved to your data folder. Includes every
          table.
        </p>
      ...
      <section className="space-y-3 rounded-xl border border-red-500/30 bg-red-500/5 p-4">
        <div className="space-y-1">
          ...
          <p className="text-caption text-text-muted">
            Permanently deletes every trade, account, session, and setting. A backup copy of your
            database is saved first. This cannot be undone.
          </p>
        </div>
        <div className="space-y-2">
          <p className="text-caption text-text-secondary">
            Type <span className="font-mono font-semibold text-text-primary">{RESET_ACK}</span> to
            confirm.
          </p>
          <Input
            value={resetConfirm}
