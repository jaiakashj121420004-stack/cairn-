    ...
    <div className="relative flex h-screen w-full items-center justify-center bg-background p-6">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        <div
          ...
          style={{
            background: 'radial-gradient(circle, hsl(var(--accent-a) / 0.08) 0%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
        <div
          ...
          style={{
            background: 'radial-gradient(circle, hsl(var(--accent-b) / 0.07) 0%, transparent 70%)',
            filter: 'blur(48px)',
          }}
        />
      </div>
          ...
          {Array.from({ length: totalSteps }).map((_, i) => (
            <div
              ...
              className={[
                ...
                i === step ? 'w-6 bg-accent-a' : i < step ? 'w-3 bg-accent-a/40' : 'w-3 bg-border',
              ].join(' ')}
            />
          ))}
        </div>
