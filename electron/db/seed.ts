  ...
  const setups: Array<typeof schema.setups.$inferInsert> = [
    {
      ...
      name: 'FVG',
      category: 'ICT',
      description: 'Fair Value Gap — an imbalance between three candles where the middle body leaves a gap.',
      color: '#D4A24C',
      active: 1,
      displayOrder: 1,
      createdAt: NOW,
    ...
    },
    {
      ...
      name: 'Order Block',
      category: 'ICT',
      description: 'Last opposing candle before a strong impulse move; institutional order concentration.',
      color: '#B4E048',
      active: 1,
      displayOrder: 2,
      createdAt: NOW,
    ...
    },
    {
      ...
      name: 'Judas Swing',
      category: 'ICT',
      description: 'Manipulation move at session open that sweeps liquidity before the true direction.',
      color: '#E25C5C',
      active: 1,
      displayOrder: 5,
      createdAt: NOW,
    ...
    },
    {
      ...
      name: 'Turtle Soup',
      category: 'SMC',
      description: 'Short-term reversal after a breakout of a 20-day high or low fails to follow through.',
      color: '#6B9FFF',
      active: 1,
      displayOrder: 9,
      createdAt: NOW,
    ...
    },
    {
      ...
      name: 'Power of Three',
      category: 'ICT',
      description: 'Accumulation, manipulation, distribution — the three-phase price delivery model.',
      color: '#B4E048',
      active: 1,
      displayOrder: 10,
      createdAt: NOW,
