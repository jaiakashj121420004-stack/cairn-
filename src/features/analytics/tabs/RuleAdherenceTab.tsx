    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        {bothEnough ? (
          ...
          <div className="mt-3">
            <InsufficientData n={Math.min(cleanVsDirty.clean.tradeCount, cleanVsDirty.dirty.tradeCount)} />
          </div>
        )}
      </div>
          ...
          <div className="h-48">
            <ResponsiveContainer>
              <LineChart data={trendLine}>
                ...
                />
                <Tooltip
                  content={<ChartTooltip formatter={(v) => formatPercent(Number(v))} />}
                />
                <Line
                  dataKey="scoreBps"
                  name="Adherence"
