...
| 4 | Live broker integration (MT5 bridge), live SL-move detection, auto-import of fills | **Paid / optional** |

Waves 0–3 are complete (see §17.6 pointer / `docs/build-status.md`). Wave 4 is isolated so the project stays useful even if it never ships. Locked decisions: §14 #30–#36. End-state criteria: §16.c (#49–#56) + `docs/roadmap-v1.2.md` §6. Long-form rationale: `Cairn_Report_Working_Friction_vs_TradeZella.html` in the project root.
