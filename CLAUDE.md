...
**Current status (2026-06-03):** v1.2 is feature-complete — Waves 0–3 all done and committed (items 1–24). Wave 3 closed out on 2026-06-01 at commit `04a82b6`/`a80cdcd`; last verified five gates green (typecheck · lint 0 · 661 unit tests · build · smoke E2E). The v0.1.1 packaged-migrations hotfix is committed (`d53be8d`, see prompts.md §8.5) but not yet repackaged/reinstalled. Next planned work: v2.0 Stage 0 (engineering-quality baseline, §18 / prompts.md §9). Wave 4 (live broker) is out of v1.2 scope.
