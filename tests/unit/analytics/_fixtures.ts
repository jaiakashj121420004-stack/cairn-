...
export const TRADES_12: TradeSpec[] = [
  // T1: clean win
  { dayIdx: 0, hour: 10, pair: 1, setup: 1, killzone: 1, direction: 'long', pnlR: 200, pnlCents: 20000, slPips: 100, rrRatio: 200, isClean: 1, rulesBroken: [], mssConfirmed: 1, dxyAligned: 1, smtConfirmed: null, preCalmScore: 8, preUrgencyScore: 3, preNeedScore: 2, revengeFlag: 0 },
  // T2: dirty loss (same day as T1 — second trade of the day)
  { dayIdx: 0, hour: 14, pair: 1, setup: 1, killzone: 1, direction: 'long', pnlR: -100, pnlCents: -10000, slPips: 100, rrRatio: 200, isClean: 0, rulesBroken: ['require_htf_bias_logged'], mssConfirmed: 1, dxyAligned: 0, smtConfirmed: 0, preCalmScore: 4, preUrgencyScore: 8, preNeedScore: 8, revengeFlag: 0 },
  // T3: clean win (big R)
  { dayIdx: 1, hour: 10, pair: 2, setup: 2, killzone: 2, direction: 'short', pnlR: 300, pnlCents: 30000, slPips: 100, rrRatio: 300, isClean: 1, rulesBroken: [], mssConfirmed: 1, dxyAligned: 1, smtConfirmed: 1, preCalmScore: 9, preUrgencyScore: 2, preNeedScore: 2, revengeFlag: 0 },
  // T4: dirty loss — multiple rules
  { dayIdx: 2, hour: 10, pair: 1, setup: 1, killzone: 1, direction: 'long', pnlR: -100, pnlCents: -10000, slPips: 100, rrRatio: 200, isClean: 0, rulesBroken: ['max_risk_per_trade', 'require_htf_bias_logged'], mssConfirmed: 1, dxyAligned: 0, smtConfirmed: 0, preCalmScore: 3, preUrgencyScore: 9, preNeedScore: 9, revengeFlag: 0 },
  // T5: dirty win — entered before MSS (same day as T4)
  { dayIdx: 2, hour: 14, pair: 1, setup: 2, killzone: 2, direction: 'long', pnlR: 100, pnlCents: 10000, slPips: 100, rrRatio: 100, isClean: 0, rulesBroken: ['entered_before_mss'], mssConfirmed: 0, dxyAligned: 0, smtConfirmed: null, preCalmScore: 5, preUrgencyScore: 5, preNeedScore: 5, revengeFlag: 0 },
  // T6: dirty loss — entered before MSS
  { dayIdx: 3, hour: 10, pair: 2, setup: 1, killzone: 1, direction: 'short', pnlR: -100, pnlCents: -10000, slPips: 100, rrRatio: 200, isClean: 0, rulesBroken: ['entered_before_mss'], mssConfirmed: 0, dxyAligned: 0, smtConfirmed: 0, preCalmScore: 3, preUrgencyScore: 9, preNeedScore: 9, revengeFlag: 0 },
  // T7: clean win
  { dayIdx: 4, hour: 10, pair: 1, setup: 1, killzone: 1, direction: 'long', pnlR: 200, pnlCents: 20000, slPips: 100, rrRatio: 200, isClean: 1, rulesBroken: [], mssConfirmed: 1, dxyAligned: 1, smtConfirmed: null, preCalmScore: 9, preUrgencyScore: 2, preNeedScore: 2, revengeFlag: 0 },
  // T8: dirty win — sl moved
  { dayIdx: 5, hour: 10, pair: 1, setup: 1, killzone: 1, direction: 'long', pnlR: 150, pnlCents: 15000, slPips: 100, rrRatio: 200, isClean: 0, rulesBroken: ['sl_moved_against'], mssConfirmed: 1, dxyAligned: null, smtConfirmed: null, preCalmScore: 6, preUrgencyScore: 6, preNeedScore: 6, revengeFlag: 0 },
  // T9: dirty loss — max trades
  { dayIdx: 6, hour: 10, pair: 2, setup: 2, killzone: 2, direction: 'short', pnlR: -100, pnlCents: -10000, slPips: 100, rrRatio: 200, isClean: 0, rulesBroken: ['max_trades_per_day'], mssConfirmed: 1, dxyAligned: 0, smtConfirmed: 0, preCalmScore: 3, preUrgencyScore: 9, preNeedScore: 9, revengeFlag: 0 },
  // T10: clean win
  { dayIdx: 7, hour: 10, pair: 1, setup: 2, killzone: 1, direction: 'long', pnlR: 200, pnlCents: 20000, slPips: 100, rrRatio: 200, isClean: 1, rulesBroken: [], mssConfirmed: 1, dxyAligned: 1, smtConfirmed: 1, preCalmScore: 8, preUrgencyScore: 3, preNeedScore: 3, revengeFlag: 0 },
  // T11: dirty loss — revenge trade
  { dayIdx: 8, hour: 10, pair: 2, setup: 1, killzone: 2, direction: 'short', pnlR: -100, pnlCents: -10000, slPips: 100, rrRatio: 200, isClean: 0, rulesBroken: ['revenge_trade'], mssConfirmed: 1, dxyAligned: 0, smtConfirmed: 0, preCalmScore: 2, preUrgencyScore: 10, preNeedScore: 10, revengeFlag: 1 },
  // T12: dirty win — sl moved
  { dayIdx: 9, hour: 10, pair: 1, setup: 1, killzone: 1, direction: 'long', pnlR: 200, pnlCents: 20000, slPips: 100, rrRatio: 200, isClean: 0, rulesBroken: ['sl_moved_against'], mssConfirmed: 1, dxyAligned: null, smtConfirmed: null, preCalmScore: 8, preUrgencyScore: 3, preNeedScore: 3, revengeFlag: 0 },
]
